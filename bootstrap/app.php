...
$app->router->group(
    [],
    function ($router) {
        require __DIR__.'/../app/Components/Documents/RegistrationOrderDocuments/routes.php';
    }
);
...
$app->router->group(
    [],
    function ($router) {
        require __DIR__.'/../app/Components/Documents/DriverExamCardDocuments/routes.php';
    }
);
...
$app->router->group(
    [],
    function ($router) {
        require __DIR__.'/../app/Components/Documents/WaybillDocuments/routes.php';
    }
);
