...
use App\Components\Documents\ScheduleDocuments\BusinessLayer\Create;
use Exception;
use Illuminate\Http\Request;

class ScheduleDocumentController extends BaseCrudController
{
    /**
     * Создание одной записи
     * POST /api/documents/schedule/create?...
     *
     */
